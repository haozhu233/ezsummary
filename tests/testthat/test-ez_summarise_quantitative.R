...
test_that("ez_summarise_quantitative can evaluate grouping info correctly with 1 variable", {
  expect_equal(names(ez_summarise_quantitative(df2)), expected = c("am", "variable", "mean", "sd"))
  expect_equal(names(ez_summarise_quantitative(df2, n=T)), expected = c("am", "variable", "N", "mean", "sd"))
...
test_that("ez_summarise_quantitative can work with 2 variables", {
  expect_equal(names(ez_summarise_quantitative(df3)), expected = c("variable", "mean", "sd"))
  expect_equal(names(ez_summarise_quantitative(df3, n=T)), expected = c("variable", "N", "mean", "sd"))
...
test_that("ez_summarise_quantitative can work with 2 variables with grouping info", {
  expect_equal(names(ez_summarise_quantitative(df4)), expected = c("am", "variable", "mean", "sd"))
  expect_equal(names(ez_summarise_quantitative(df4, n=T)), expected = c("am", "variable", "N", "mean", "sd"))
