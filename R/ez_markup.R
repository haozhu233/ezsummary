...
ez_markup <- function(tbl, pattern){
  ...
  table_export <- ez_markup_(tbl=tbl, general_pattern = general_pattern, table_export = table_export)
  return(table_export)
}

ez_markup_ <- function(tbl, general_pattern, table_export){
...
ez_markup_bracket <- function(tbl, bracket_pattern, column_export="", column_name_export="", number_of_dots=0, number_of_characters = 1){
